    ...
    const helpModal = (
      <Modal hidden={!this.state.isHelpModalOpen} onCloseIntention={this.toggleHelpModal}>
        <Dialog>
          ...
          <p>
            <ul>
               <li>Paina vasemmalla sivupalkissa olevaa +Luo uusi -nappia, mikäli haluat luoda uuden tapauksen.</li>
               ...
               <li>Painamalla +-nappia Vaiheet-sanan alapuolelta voit lisätä tapaukseen haluamasi määrän vaiheita.</li>
